...
--
--  Contient TOUT : site public, CRM, avis par lien, synchronisation
--  du calendrier, musiques client, statistiques et facturation.
--
--  MODE D'EMPLOI
--    Supabase → SQL Editor → nouvelle requête → coller ce fichier → Run.
--    C'est le SEUL fichier à exécuter. Inutile d'en lancer d'autres.
--
--  ⚠️ NON DESTRUCTIF
...
-- ==================================================================
-- PARTIE 3 — FACTURATION (devis, factures, paiements)
-- ==================================================================
...
--  TERMINÉ.
--
--  Vérifications rapides ensuite :
--    · Table Editor → vous devez voir : site_content, gallery_items,
--      photos, reviews, calendar_events, reservations, media_assets,
--      analytics_events, clients, prestataires, review_invites,
--      doc_counters, facturation_settings, paiements.
--    · Authentication → Users → votre compte admin doit exister.
--
